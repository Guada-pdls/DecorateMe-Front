        ...
        load ? 'cargando'
            : <>
                <section className='productsSection'>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center', marginBottom: '4rem' }}>
                        <Search sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
                        <TextField label="Search product" variant="standard" onChange={(e) => {
                    ...
                    <Pagination count={totalPages} page={page} onChange={(e, value) => handleChange(e, value)} />
                </section>
            </>
    )
}
